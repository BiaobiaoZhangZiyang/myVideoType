...
int main(){
    ...
    cv::Mat logo_orignal = cv::imread("/home/zzy/Desktop/myVideoType/pics/zju_white.png", 1);
    cv::Mat grayLogo;
    cv::cvtColor(logo_orignal, grayLogo, cv::COLOR_BGR2GRAY);
    tools::showCurrentPics(windowName, grayLogo);
